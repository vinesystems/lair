...
mod tests {
    ...
    fn wide() {
        ...
        assert_abs_diff_eq!(
            q,
            arr2(&[
                [-0.26726124, -0.756_978_1, -0.596_284_8],
                [-0.534_522_5, -0.39840954, 0.74535599],
                [-0.80178373, 0.5179324, -0.2981424]
            ]),
            epsilon = 1e-6
        );
        ...
        assert_abs_diff_eq!(
            ...
            arr2(&[
                ...
                [0., -1.792_842_9, -1.6334791, -0.916_341_9],
                [0., 0., -1.639_783_1, 1.043_498_4]
            ]),
            epsilon = 1e-6
        );
    }
    ...
    fn tall() {
        ...
        assert_abs_diff_eq!(
            ...
            arr2(&[
                ...
                [-0.70710677, -0.63960215, -0.29523511, 0.06119901],
